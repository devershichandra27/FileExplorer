/*program to add response to enter key in list*/
//the program displays the name of selected file :-)
#include <unistd.h>
#include <iostream>
#include <dirent.h>
#include <sys/stat.h>
...
void detectArrowKey(){
    while(true) {
        ...
        if(ch==27){
            ...
            cout << "Current file is " << indexmapper[cursorindex] << endl;
            printf("\033[1;1H");
